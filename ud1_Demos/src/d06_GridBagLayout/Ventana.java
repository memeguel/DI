...
public class Ventana extends JFrame{
    ...
    private void anadirComponentes() {
        ...
        colocarComponentesGridBag(0,0,2,2,txtA1,this);
        JButton bt1=new JButton("Botón 1");
        colocarComponentesGridBag(2,0,1,1,bt1,this);
        
        //Fila 1----------------------
        JButton bt2=new JButton("Botón 2");
        colocarComponentesGridBag(2,1,1,1,bt2,this);
        
        //Fila 2----------------------
        JButton bt3=new JButton("Botón 3");
        colocarComponentesGridBag(0,2,1,1,bt3,this);
        JTextField txtF1=new JTextField("Campo texto");
        colocarComponentesGridBag(1,2,1,1,txtF1,this);
        JButton bt4=new JButton("Botón 4");
        colocarComponentesGridBag(2,2,1,1,bt4,this);
    }

    private void colocarComponentesGridBag(int columna, int fila, int anchoCol, int altoFila, JComponent elemento, Ventana ventana) {
